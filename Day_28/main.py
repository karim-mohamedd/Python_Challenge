...
canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthickness=0)  #highlightthickness is to remove the border of the photo #canvas is class allows u to add layers on each other like text on image etc
tomato_img = PhotoImage(file="tomato.png")  # This is the way to get hold of photo and use it 

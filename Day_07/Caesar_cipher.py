...
⠀⠀⠀⠀⠀⠀⠀⠙⠻⠿⣿⣿⣿⣿⣿⣿⣿⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠉⠉⠉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀''')
print("================== Hello iam Caesar Cipher i will help you to encrypt and decrypt your message ==================")
...
def decrypt(cipher_text, shift):
    ...
    print(f"The original text is:  {final_text}\n")


not_end = True
while not_end:
    x = input("Do you want to decrypt or encrypt: ")
    if x == "decrypt":
        ...
        print("Error, please enter encrypt or decrypt to start: ")
